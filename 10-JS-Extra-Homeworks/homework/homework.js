...
function numberOfCharacters(string) {
  ...
  //Ej: Recibe ---> "asdjfdsfsfjsdjfhacabcsbajda" || Devuelve ---> { a: 5, b: 2, c: 2, d: 4, f: 4, h:1, j: 4, s: 5 } 
  //Escribe tu código aquí
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //retornar un nuevo array con la intersección de ambos elementos. (Ej: [4,2,3] unión 0 = [3,4].
